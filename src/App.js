    ...
    return(
        ...
        <section className='all'>
         <section className='head'>
            ...
            <h2 className='hed'>Delgon technologies</h2>
        ...
        <section className='footer'>
            <div className='about'>
            <h5>About Delgon Technologies </h5>
            <div className='elems'><div><FaLocationArrow/></div><p>Delgon Technologies,Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, aut?</p></div>
        ...
        <section className='bottom'>
          © 2022 Delgon Technologies All Rights Reserved.
        </section>
        </section>
        </>
    )
